...
const Navbar = () => {
  ...
  useEffect(() => {
    if (isSuccess) {
      toast.success(data.message || "Kisne Bola Logout Hone Ko!");
      navigate("login");
    }
  }, [isSuccess]);
  return (
    <div className="h-16 dark:bg-[#A0A0A0] bg-white border-b-gray-800 border-b-gray-200 fixed top-0 left-0 right-0 duration-300 z-10">
      {/* desktop */}
