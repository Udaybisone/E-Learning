...
const CourseTab = () => {
  ...
  const [publishCourse,{error:publishCourseError}] = usePublishCourseMutation();
  ...
  useEffect(()=>{
    if(publishCourseError){
      toast(publishCourseError.data.message)
    }
  },[publishCourseError])
  ...
  if(courseByIdIsLoading) return <h1>Louding.....</h1>
          ...
          <div>
            ...
            {previewThumbnail && (
              <img
                ...
                className="h-[15rem] w-[20rem] e-64 my-2"
